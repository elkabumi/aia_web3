...
jQuery(function($){
	...
	$('#navbar .nav a , #header a.nav-item , #navbar .brand,#btn_up').click(function(e){
		...
		if(des == "available_event.html"){
			window.location.href = "available_event.html";
		}else if(des == "registered_event.html"){
			window.location.href = "registered_event.html";
		}else if(des == "elearning.html"){
